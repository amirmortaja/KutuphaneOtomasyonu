...
namespace Kutuphane2
{
    public partial class FormKitapIslemleri : Form
    {
        ...
        string sorgu = "t1.ISBN,t1.ad as Ad,t1.yazar as Yazar, t3.kategoriAdi as Kategori, t1.baskiYili as Yıl, t1.yayinEvi as Yayın, t1.sayfaSayisi as Sayfa, t1.aciklama as Detay";
        ...
        private bool CheckIt()
        {
            ...
            if (btnISBN.Text == "" || adTxt.Text == "" || yazarTxt.Text == "" || kategoriCombobox.Text == "" || baskiYiliTxt.Text == "" || yayinEviTxt.Text == "" || sayfaSayisiTxt.Text == "" || aciklamaTxt.Text == "")
            {
                output = false;
            }
